...
const bool GlobalVariables::RevivalPadSettings::defaultDisabledWinEnhanced = false;
const bool GlobalVariables::RevivalPadSettings::defaultAssociateProfiles = true;
const int GlobalVariables::RevivalPadSettings::defaultSpringScreen = -1;
const int GlobalVariables::RevivalPadSettings::defaultSDLGamepadPollRate = 10; // unsigned
