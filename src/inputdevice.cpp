...
InputDevice::InputDevice(SDL_Joystick *joystick, int deviceIndex, RevivalPadSettings *settings, QObject *parent)
    : QObject(parent)
    , m_calibrations(this)
{
    buttonDownCount = 0;
...
RevivalPadSettings *InputDevice::getSettings() { return m_settings; }
