...
class InputDevice : public QObject
{
  ...
  public:
    explicit InputDevice(SDL_Joystick *joystick, int deviceIndex, RevivalPadSettings *settings, QObject *parent);
    virtual ~InputDevice();
    ...
    RevivalPadSettings *getSettings();
