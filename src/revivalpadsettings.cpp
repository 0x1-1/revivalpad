...
const bool RevivalPadSettings::defaultDisabledWinEnhanced = false;

RevivalPadSettings::RevivalPadSettings(const QString &fileName, Format format, QObject *parent)
 ...
 */
QVariant RevivalPadSettings::runtimeValue(const QString &key, const QVariant &defaultValue) const
{
 ...
 */
void RevivalPadSettings::importFromCommandLine(CommandLineUtility &cmdutility)
{
 ...
 */
void RevivalPadSettings::applySettingsToLogger(CommandLineUtility &cmdutility, Logger *logger_ptr)
{
...
QMutex *RevivalPadSettings::getLock() { return &lock; }

QSettings &RevivalPadSettings::getCmdSettings() { return cmdSettings; }
