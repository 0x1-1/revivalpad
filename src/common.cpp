...
{
    VERBOSE() << REVIVALPAD_DISPLAY_NAME " version: " << PadderCommon::programVersion
              << " (based on " REVIVALPAD_UPSTREAM_NAME " " REVIVALPAD_UPSTREAM_BASE_VERSION ")"
#ifdef REVIVALPAD_PKG_VERSION
              << " Package: " << REVIVALPAD_PKG_VERSION
#endif
#ifdef QT_DEBUG
              << " Type: Debug"
#else
