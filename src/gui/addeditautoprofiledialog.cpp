...
AddEditAutoProfileDialog::AddEditAutoProfileDialog(AutoProfileInfo *info, RevivalPadSettings *settings,
...
RevivalPadSettings *AddEditAutoProfileDialog::getSettings() const { return settings; }
