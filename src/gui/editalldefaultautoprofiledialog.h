...
class EditAllDefaultAutoProfileDialog : public QDialog
{
  ...
  public:
    explicit EditAllDefaultAutoProfileDialog(AutoProfileInfo *info, RevivalPadSettings *settings, QWidget *parent = nullptr);
    ~EditAllDefaultAutoProfileDialog();

    AutoProfileInfo *getAutoProfile() const;
    RevivalPadSettings *getSettings() const;
