...
void MainSettingsDialog::fillSpringScreenPresets()
{
    ...
    ui->springScreenComboBox->addItem(tr("Default"), QVariant(GlobalVariables::RevivalPadSettings::defaultSpringScreen));
...
RevivalPadSettings *MainSettingsDialog::getSettings() const { return settings; }
