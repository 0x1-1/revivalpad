...
#ifndef REVIVALPADSETTINGS_H
#define REVIVALPADSETTINGS_H

#include "commandlineutility.h"

#include <QSettings>

class RevivalPadSettings : public QSettings
{
    Q_OBJECT

  public:
    explicit RevivalPadSettings(const QString &fileName, Format format, QObject *parent = nullptr);
